  ...
  constructor(binding9) {
    ...
    Object.defineProperties(this, {
      ...
      resolvedModule: {
        enumerable: true,
        get() {
          return binding9.resolvedModule ? Module.__from_binding(binding9.resolvedModule) : null;
        }
      },
      originModule: {
        enumerable: true,
        get() {
          return binding9.originModule ? Module.__from_binding(binding9.originModule) : null;
        }
      }
    });
  }
...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
  ...
  get entrypoints() {
    return new Map(
      __privateGet(this, _inner).entrypoints.map((binding9) => {
        const entrypoint = Entrypoint.__from_binding(binding9);
  ...
  get chunkGroups() {
    return __privateGet(this, _inner).chunkGroups.map(
      (binding9) => ChunkGroup.__from_binding(binding9)
    );
  }
  /**
    ...
    return createReadonlyMap({
      ...
      get: (property) => {
        if (typeof property === "string") {
          ...
          return binding9 ? Chunk.__from_binding(binding9) : void 0;
        }
      }
    });
  }
...
async function runLoaders(compiler, context2) {
  ...
  loaderContext.experiments = {
    emitDiagnostic: (diagnostic) => {
      ...
      compiler._lastCompilation.__internal__pushDiagnostic(
        (0, import_binding2.formatDiagnostic)(d)
      );
    }
  };
  ...
  try {
    switch (loaderState) {
      case import_binding2.JsLoaderState.Pitching: {
      ...
      case import_binding2.JsLoaderState.Normal: {
...
function getRawRuleSetCondition(condition) {
  if (typeof condition === "string") {
    return {
      type: import_binding3.RawRuleSetConditionType.string,
      string: condition
    };
  }
  if (condition instanceof RegExp) {
    return {
      type: import_binding3.RawRuleSetConditionType.regexp,
      regexp: condition
    };
  }
  if (typeof condition === "function") {
    return {
      type: import_binding3.RawRuleSetConditionType.func,
      func: condition
    };
  }
  if (Array.isArray(condition)) {
    return {
      type: import_binding3.RawRuleSetConditionType.array,
      array: condition.map((i) => getRawRuleSetCondition(i))
    };
  }
  if (typeof condition === "object" && condition !== null) {
    return {
      type: import_binding3.RawRuleSetConditionType.logical,
...
var APIPlugin = create2(import_binding4.BuiltinPluginName.APIPlugin, () => {
});
...
var ArrayPushCallbackChunkFormatPlugin = create2(
  import_binding5.BuiltinPluginName.ArrayPushCallbackChunkFormatPlugin,
  () => {
  }
);
...
var AssetModulesPlugin = create2(
  import_binding6.BuiltinPluginName.AssetModulesPlugin,
  () => {
  },
  "compilation"
);
...
var AsyncWebAssemblyModulesPlugin = create2(
  import_binding7.BuiltinPluginName.AsyncWebAssemblyModulesPlugin,
  () => {
  },
  "compilation"
);
...
var BannerPlugin = create2(
  import_binding8.BuiltinPluginName.BannerPlugin,
  (args) => {
...
var BundlerInfoRspackPlugin = create2(
  import_binding9.BuiltinPluginName.BundlerInfoRspackPlugin,
  (options) => {
    return {
...
var ChunkPrefetchPreloadPlugin = create2(
  import_binding10.BuiltinPluginName.ChunkPrefetchPreloadPlugin,
  () => {
  }
);
...
var CommonJsChunkFormatPlugin = create2(
  import_binding11.BuiltinPluginName.CommonJsChunkFormatPlugin,
  () => {
  }
);
...
var CopyRspackPlugin = create2(
  import_binding12.BuiltinPluginName.CopyRspackPlugin,
  (copy) => {
    const ret = {
      patterns: []
    };
...
var CssExtractRspackPlugin = class {
  ...
  apply(compiler) {
    ...
    compiler.__internal__registerBuiltinPlugin({
      name: import_binding13.BuiltinPluginName.CssExtractRspackPlugin,
...
var CssModulesPlugin = create2(
  import_binding14.BuiltinPluginName.CssModulesPlugin,
  () => {
  },
  "compilation"
);
...
var DataUriPlugin = create2(
  import_binding15.BuiltinPluginName.DataUriPlugin,
  () => {
  },
  "compilation"
);
...
var DefinePlugin = create2(
  import_binding16.BuiltinPluginName.DefinePlugin,
  function(define) {
    var _a;
...
var DeterministicChunkIdsPlugin = class extends RspackBuiltinPlugin {
  constructor() {
    super(...arguments);
    this.name = import_binding17.BuiltinPluginName.DeterministicChunkIdsPlugin;
...
var DeterministicModuleIdsPlugin = class extends RspackBuiltinPlugin {
  constructor() {
    super(...arguments);
    this.name = import_binding18.BuiltinPluginName.DeterministicModuleIdsPlugin;
    this.affectedHooks = "compilation";
  }
  raw(compiler) {
    const incremental2 = compiler.options.experiments.incremental;
...
var OriginEntryPlugin = create2(
  import_binding19.BuiltinPluginName.EntryPlugin,
...
var DynamicEntryPlugin = class extends RspackBuiltinPlugin {
  constructor(context2, entry2) {
    ...
    this.entry = entry2;
    this.name = import_binding20.BuiltinPluginName.DynamicEntryPlugin;
...
var ElectronTargetPlugin = create2(
  import_binding21.BuiltinPluginName.ElectronTargetPlugin,
...
var EnableChunkLoadingPluginInner = create2(
  import_binding22.BuiltinPluginName.EnableChunkLoadingPlugin,
  (type) => type
);
...
var EnableLibraryPlugin = class extends RspackBuiltinPlugin {
  constructor(type) {
    super();
    this.type = type;
    this.name = import_binding23.BuiltinPluginName.EnableLibraryPlugin;
  }
  static setEnabled(compiler, type) {
...
var EnableWasmLoadingPlugin = create2(
  import_binding24.BuiltinPluginName.EnableWasmLoadingPlugin,
  (type) => type
);
...
var EnsureChunkConditionsPlugin = create2(
  import_binding25.BuiltinPluginName.EnsureChunkConditionsPlugin,
  () => {
  }
);
...
var EvalDevToolModulePlugin = create2(
  import_binding26.BuiltinPluginName.EvalDevToolModulePlugin,
  (options) => options,
  "compilation"
);
...
var EvalSourceMapDevToolPlugin = create2(
  import_binding27.BuiltinPluginName.EvalSourceMapDevToolPlugin,
  (options) => {
    return {
...
var RsdoctorPluginImpl = create2(
  import_binding73.BuiltinPluginName.RsdoctorPlugin,
  function(c = {
...
var createRsdoctorPluginHooksRegisters = (getCompiler, createTap, createMapTap) => {
  return {
    registerRsdoctorPluginModuleGraphTaps: createTap(
      import_binding73.RegisterJsTapKind.RsdoctorPluginModuleGraph,
      function() {
    ...
    registerRsdoctorPluginChunkGraphTaps: createTap(
      import_binding73.RegisterJsTapKind.RsdoctorPluginChunkGraph,
      function() {
        return RsdoctorPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).chunkGraph;
    ...
    registerRsdoctorPluginModuleIdsTaps: createTap(
      import_binding73.RegisterJsTapKind.RsdoctorPluginModuleIds,
      function() {
        return RsdoctorPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).moduleIds;
    ...
    registerRsdoctorPluginModuleSourcesTaps: createTap(
      import_binding73.RegisterJsTapKind.RsdoctorPluginModuleSources,
      function() {
        return RsdoctorPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).moduleSources;
    ...
    registerRsdoctorPluginAssetsTaps: createTap(
      import_binding73.RegisterJsTapKind.RsdoctorPluginAssets,
      function() {
        return RsdoctorPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).assets;
